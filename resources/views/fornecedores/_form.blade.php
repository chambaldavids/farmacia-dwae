@php $fornecedor = $fornecedor ?? null; @endphp

<div class="row">
    <div class="col-12 col-md-6 mb-3">
        <label for="nome" class="form-label">Nome *</label>
        <input type="text" name="nome" id="nome" class="form-control @error('nome') is-invalid @enderror"
               value="{{ old('nome', $fornecedor->nome ?? '') }}" required maxlength="150">
    ...
    <div class="col-12 col-md-6 mb-3">
        ...
        <input type="text" name="nuit" id="nuit" class="form-control @error('nuit') is-invalid @enderror"
               value="{{ old('nuit', $fornecedor->nuit ?? '') }}" maxlength="20">
